...
public class groceryBills extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_grocery_bills);
        ...
        Query query = databaseReference.orderByChild("type").equalTo("grocery");
        ...
        FirebaseRecyclerOptions<Bill> options =
                new FirebaseRecyclerOptions.Builder<Bill>()
                        ...
                        .build();
        adapter = new BillAdapter(options, groceryBills.this,phone);
