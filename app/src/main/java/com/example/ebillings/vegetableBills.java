...
public class vegetableBills extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_vegetable_bills);
        ...
        Query query = databaseReference.orderByChild("type").equalTo("vegetables");
        ...
        FirebaseRecyclerOptions<Bill> options =
                new FirebaseRecyclerOptions.Builder<Bill>()
                        ...
                        .build();
        adapter = new BillAdapter(options, vegetableBills.this,phone);
